...
lsblk_opt('ALIGNMENT', 'alignment offset').
lsblk_opt('DISC-ALN', 'discard alignment offset').
lsblk_opt('DAX', 'dax-capable device').
lsblk_opt('DISC-GRAN', 'discard granularity').
lsblk_opt('DISC-MAX', 'discard max bytes').
lsblk_opt('DISC-ZERO', 'discard zeroes data').
lsblk_opt('FSAVAIL', 'filesystem size available').
lsblk_opt('FSROOTS', 'mounted filesystem roots').
lsblk_opt('FSSIZE', 'filesystem size').
lsblk_opt('FSTYPE', 'filesystem type').
lsblk_opt('FSUSED', 'filesystem size used').
lsblk_opt('FSUSE%', 'filesystem use percentage').
lsblk_opt('FSVER', 'filesystem version').
lsblk_opt('GROUP', 'group name').
lsblk_opt('HCTL', 'Host:Channel:Target:Lun for SCSI').
lsblk_opt('HOTPLUG', 'removable or hotplug device (usb, pcmcia, ...)').
lsblk_opt('KNAME', 'internal kernel device name').
lsblk_opt('LABEL', 'filesystem LABEL').
lsblk_opt('LOG-SEC', 'logical sector size').
lsblk_opt('MAJ:MIN', 'major:minor device number').
lsblk_opt('MIN-IO', 'minimum I/O size').
lsblk_opt('MODE', 'device node permissions').
lsblk_opt('MODEL', 'device identifier').
lsblk_opt('NAME', 'device name').
lsblk_opt('OPT-IO', 'optimal I/O size').
lsblk_opt('OWNER', 'user name').
lsblk_opt('PARTFLAGS', 'partition flags').
lsblk_opt('PARTLABEL', 'partition LABEL').
lsblk_opt('PARTTYPE', 'partition type code or UUID').
lsblk_opt('PARTTYPENAME', 'partition type name').
lsblk_opt('PARTUUID', 'partition UUID').
lsblk_opt('PATH', 'path to the device node').
lsblk_opt('PHY-SEC', 'physical sector size').
lsblk_opt('PKNAME', 'internal parent kernel device name').
lsblk_opt('PTTYPE', 'partition table type').
lsblk_opt('PTUUID', 'partition table identifier (usually UUID)').
lsblk_opt('RA', 'read-ahead of the device').
lsblk_opt('RAND', 'adds randomness').
lsblk_opt('REV', 'device revision').
lsblk_opt('RM', 'removable device').
lsblk_opt('RO', 'read-only device').
lsblk_opt('ROTA', 'rotational device').
lsblk_opt('RQ-SIZE', 'request queue size').
lsblk_opt('SCHED', 'I/O scheduler name').
lsblk_opt('SERIAL', 'disk serial number').
lsblk_opt('SIZE', 'size of the device').
lsblk_opt('START', 'partition start offset').
lsblk_opt('STATE', 'state of the device').
lsblk_opt('SUBSYSTEMS', 'de-duplicated chain of subsystems').
lsblk_opt('MOUNTPOINT', 'where the device is mounted').
lsblk_opt('MOUNTPOINTS', 'all locations where device is mounted').
lsblk_opt('TRAN', 'device transport type').
lsblk_opt('TYPE', 'device type').
lsblk_opt('UUID', 'filesystem UUID').
lsblk_opt('VENDOR', 'device vendor').
lsblk_opt('WSAME', 'write same max bytes').
lsblk_opt('WWN', 'unique storage identifier').
lsblk_opt('ZONED', 'zone model').
lsblk_opt('ZONE-SZ', 'zone size').
lsblk_opt('ZONE-WGRAN', 'zone write granularity').
lsblk_opt('ZONE-APP', 'zone append max bytes').
lsblk_opt('ZONE-NR', 'number of zones').
lsblk_opt('ZONE-OMAX', 'maximum number of open zones').
lsblk_opt('ZONE-AMAX', 'maximum number of active zones').
